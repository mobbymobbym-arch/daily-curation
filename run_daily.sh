...
# Deep analysis has 120s per Gemini/network request; these are stage-level deadman guards.
DEEP_ANALYSIS_STEP_TIMEOUT_SECONDS="${DEEP_ANALYSIS_STEP_TIMEOUT_SECONDS:-1200}"
DEEP_ANALYSIS_TIMEOUT_RETRY_DELAY_SECONDS="${DEEP_ANALYSIS_TIMEOUT_RETRY_DELAY_SECONDS:-120}"
DEEP_ANALYSIS_TIMEOUT_RETRY_SECONDS="${DEEP_ANALYSIS_TIMEOUT_RETRY_SECONDS:-900}"
